...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri May 12 15:12:47 CEST 2017
  */
          ...
          case 104: // NT$11 ::= 
            {
              Obj RESULT =null;
				...
				GeneratorHelper.expressionHasParen.pop();
				GeneratorHelper.expressionHasParen.push(true);
...
//							}
		...
		Obj RightTermList = (Obj)((java_cup.runtime.Symbol) CUP$MJParser$stack.peek()).value;
					...
					boolean inParen = GeneratorHelper.expressionHasParen.pop();
					//additionalPopsNeeded = GeneratorHelper.additionalPopsNeeded.pop();
					if(RightTermList.getType().getKind() == Struct.Array && !GeneratorHelper.constructorCall && !inParen) {
						GeneratorHelper.removeIndicesAndResetTimes(RightTermList);
					} else
						//GeneratorHelper.additionalPopsNeeded = 4;
		...
		Boolean Minus = (Boolean)((java_cup.runtime.Symbol) CUP$MJParser$stack.peek()).value;
					...
					GeneratorHelper.expressionHasParen.push(false);
